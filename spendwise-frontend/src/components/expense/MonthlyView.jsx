  ...
  const SummaryCards = () => (
    <div className="grid grid-cols-2 gap-3 mb-4">
      <div className={`${t.card} ${t.border} border rounded-xl p-3`}>
        <p className={`text-xs uppercase tracking-wider mb-1 ${t.muted}`}>This Month</p>
        <p className={`text-lg font-bold ${t.text}`}>
          ₹{total.toLocaleString("en-IN", { minimumFractionDigits: 2 })}
        </p>
      </div>
      <div className={`${t.card} ${t.border} border rounded-xl p-3`}>
        <p className={`text-xs uppercase tracking-wider mb-1 ${t.muted}`}>vs Last Month</p>
      ...
      <div className={`${t.card} ${t.border} border rounded-xl p-3 col-span-2`}>
        <p className={`text-xs uppercase tracking-wider mb-1 ${t.muted}`}>Last Month Total</p>
            ...
            <div key={cat}>
              <div className="flex justify-between text-xs mb-1">
                ...
                <span className={t.muted}>
                  ₹{amt.toLocaleString("en-IN", { minimumFractionDigits: 2 })} · {pct.toFixed(0)}%
                </span>
              </div>
